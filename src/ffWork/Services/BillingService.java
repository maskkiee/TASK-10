...
public class BillingService implements Billable {
    ...
    private static final DateTimeFormatter timeFormat = DateTimeFormatter.ofPattern("yyyyMMdd");

    public BillingService(BookingRepository bookingRepo) {
        this.bookingRepo = bookingRepo;
    }

    public void validateInvoice(Booking booking) {
